        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="footer-section">
            ...
            <p className="text-gray-400 mb-4 max-w-xs">
              Create engaging polls, gather insights, and make data-driven decisions with our modern polling platform.
            </p>
          ...
          <div className="footer-section">
            ...
            <ul className="space-y-3">
              <li><Link href="/polls" className="footer-link">Browse Polls</Link></li>
              <li><Link href="/polls/create" className="footer-link">Create Poll</Link></li>
              <li><Link href="/features" className="footer-link">Features</Link></li>
              <li><Link href="/pricing" className="footer-link">Pricing</Link></li>
              <li><Link href="/api" className="footer-link">API</Link></li>
            </ul>
          </div>
